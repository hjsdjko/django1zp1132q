...
<div :style='{"width":"68%","padding":"80px 0","margin":"10px auto","position":"relative","background":"transparent"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="工号" prop="gonghao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="教师姓名" prop="xingming">
            <el-input v-model="ruleForm.xingming" 
                placeholder="教师姓名" clearable :disabled=" false  ||ro.xingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="职称" prop="zhicheng">
            <el-input v-model="ruleForm.zhicheng" 
                placeholder="职称" clearable :disabled=" false  ||ro.zhicheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="电话" prop="dianhua">
            <el-input v-model="ruleForm.dianhua" 
                placeholder="电话" clearable :disabled=" false  ||ro.dianhua"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="邮箱" prop="youxiang">
