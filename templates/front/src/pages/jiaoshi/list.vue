...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","top":"130px","flexWrap":"wrap","left":"0","background":"transparent","display":"flex","width":"20%","position":"absolute","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>教师姓名：</div>
        <el-input v-model="formSearch.xingming" placeholder="教师姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	...
	<div class="list" :style='{"minHeight":"600px","width":"80%","padding":"0","margin":"0 0 0 20%","background":"#F6F6F6"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 0","flexWrap":"wrap","background":"#F6F6F6","display":"flex","height":"auto"}'>
			<div :style='{"border":"4px solid #fff","padding":"10px 20px","margin":"10px 5px","flexWrap":"wrap","background":"#fff","display":"flex","width":"32%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<img @click.stop="imgPreView(item.touxiang)" :style='{"width":"100%","objectFit":"cover","display":"block","height":"275px","order":"2"}' v-if="item.touxiang && item.touxiang.substr(0,4)=='http'" :src="item.touxiang.split(',')[0]" class="image" />
				<img @click.stop="imgPreView(baseUrl + (item.touxiang?item.touxiang.split(',')[0]:''))" :style='{"width":"100%","objectFit":"cover","display":"block","height":"275px","order":"2"}' v-else :src="baseUrl + (item.touxiang?item.touxiang.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 10px 10px","color":"#000000","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.gonghao}}</div>
