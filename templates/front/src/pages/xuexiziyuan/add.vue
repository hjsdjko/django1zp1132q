...
<div :style='{"width":"68%","padding":"80px 0","margin":"10px auto","position":"relative","background":"transparent"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="资源名称" prop="ziyuanmingcheng">
            <el-input v-model="ruleForm.ziyuanmingcheng" 
                placeholder="资源名称" clearable :disabled=" false  ||ro.ziyuanmingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}'  label="资源分类" prop="ziyuanfenlei">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="资源文件" prop="ziyuanwenjian">
            <file-upload
            tip="点击上传资源文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="资源简述" prop="ziyuanjianshu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="资源简述"
              v-model="ruleForm.ziyuanjianshu">
            </el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="资源详情" prop="ziyuanxiangqing">
            <editor 
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('xuexiziyuan/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`xuexiziyuan/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
