<template>
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231003/cc88bae96def417689c07dc1358d4a32.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
	...
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 0px 20px 0px","alignItems":"center","color":"#62779c","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 2% 20px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","flexDirection":"row-reverse","display":"flex","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20231003/b8ae010ba2ff44268dee3545917b55dd.png) no-repeat right bottom / 80% 80%,#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('xuesheng','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{xueshengCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>学生总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 2% 20px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","flexDirection":"row-reverse","display":"flex","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20231003/b8ae010ba2ff44268dee3545917b55dd.png) no-repeat right bottom / 80% 80%,#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('jiaoshi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"80px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji7" :style='{"color":"inherit","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{jiaoshiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>教师总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 2% 20px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","flexDirection":"row-reverse","display":"flex","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20231003/b8ae010ba2ff44268dee3545917b55dd.png) no-repeat right bottom / 80% 80%,#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('xuexiziyuan','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"80px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji7" :style='{"color":"inherit","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{xuexiziyuanCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>学习资源总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 2% 20px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","flexDirection":"row-reverse","display":"flex","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20231003/b8ae010ba2ff44268dee3545917b55dd.png) no-repeat right bottom / 80% 80%,#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('kechengxinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"80px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji7" :style='{"color":"inherit","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"flex-start","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{kechengxinxiCount}}</div>
	...
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="xuexiziyuanChart1" class="echarts1" v-if="isAuth('xuexiziyuan','首页统计')"></div>
		<div id="xuexiziyuanChart2" class="echarts2" v-if="isAuth('xuexiziyuan','首页统计')"></div>
		<div id="kechengxinxiChart1" class="echarts3" v-if="isAuth('kechengxinxi','首页统计')"></div>
		<div id="kechengxinxiChart2" class="echarts4" v-if="isAuth('kechengxinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		this.getxuexiziyuanCount();
		this.xuexiziyuanChat1();
		this.xuexiziyuanChat2();
		this.getkechengxinxiCount();
		this.kechengxinxiChat1();
		this.kechengxinxiChat2();
	},
	methods:{
		// 词云
		...
		getxuexiziyuanCount() {
			this.$http({
				url: `xuexiziyuan/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.xuexiziyuanCount = data.data
				}
			})
		},
		xuexiziyuanChat1() {
        ...
        var xuexiziyuanChart1 = echarts.init(document.getElementById("xuexiziyuanChart1"),'roma');
        this.$http({
            url: "xuexiziyuan/group/ziyuanfenlei",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                xuexiziyuanChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    xuexiziyuanChart1.resize();
                };
            }
        });
      })
    ...
    xuexiziyuanChat2() {
      this.$nextTick(()=>{
        ...
        var xuexiziyuanChart2 = echarts.init(document.getElementById("xuexiziyuanChart2"),'roma');
        this.$http({
            url: "xuexiziyuan/group/xingming",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                xuexiziyuanChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    xuexiziyuanChart2.resize();
                };
            }
        });
      })
        ...
        var kechengxinxiChart1 = echarts.init(document.getElementById("kechengxinxiChart1"),'roma');
        this.$http({
    ...
    kechengxinxiChat2() {
      this.$nextTick(()=>{
        ...
        var kechengxinxiChart2 = echarts.init(document.getElementById("kechengxinxiChart2"),'roma');
        this.$http({
            url: "kechengxinxi/group/xingming",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                kechengxinxiChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    kechengxinxiChart2.resize();
                };
            }
        });
      })
